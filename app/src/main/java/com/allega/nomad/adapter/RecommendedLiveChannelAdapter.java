 ...
 */
public class RecommendedLiveChannelAdapter extends AbstractAdapter<LiveChannel> {

    public RecommendedLiveChannelAdapter(Context context, List<LiveChannel> items) {
        super(context, items);
    }
