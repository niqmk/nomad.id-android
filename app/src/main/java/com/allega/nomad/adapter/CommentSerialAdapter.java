 ...
 */
public class CommentSerialAdapter extends RealmAdapter<SerialEpisodeComment> {

    public CommentSerialAdapter(Context context, RealmResults<SerialEpisodeComment> items) {
        super(context, items);
    }
