...
public class ADZAESUtils {

    private static byte[] preCalculateMultipleByTwo = new byte[]{
    ...
    private static byte[] preCalculateMultipleByThree = new byte[]{
    ...
    private static byte[] preCalculateMultipleByNine = new byte[]{
    ...
    private static byte[] preCalculateMultipleByEleven = new byte[]{
    ...
    private static byte[] preCalculateMultipleByThirteen = new byte[]{
    ...
    private static byte[] preCalculateMultipleByFourteen = new byte[]{
    ...
    public static byte xorBytes(byte firstByte, byte secondByte) {
        int resultInt = (int) firstByte ^ (int) secondByte;

        byte resultByte = (byte) (0xff & resultInt);
        return resultByte;
    }

    public static byte multipleGaloisField(byte data, int counter) {

        switch (counter) {
            case 1:
                return data;
            case 2:
                return preCalculateMultipleByTwo[data + 128];
            case 3:
                return preCalculateMultipleByThree[data + 128];
            case 9:
                return preCalculateMultipleByNine[data + 128];
            case 11:
                return preCalculateMultipleByEleven[data + 128];
            case 13:
                return preCalculateMultipleByThirteen[data + 128];
            case 14:
                return preCalculateMultipleByFourteen[data + 128];
