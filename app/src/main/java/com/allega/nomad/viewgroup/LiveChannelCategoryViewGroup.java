 ...
 */
public class LiveChannelCategoryViewGroup extends RelativeLayout {
    ...
    public LiveChannelCategoryViewGroup(Context context) {
        super(context);
        init();
    }

    public LiveChannelCategoryViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LiveChannelCategoryViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
