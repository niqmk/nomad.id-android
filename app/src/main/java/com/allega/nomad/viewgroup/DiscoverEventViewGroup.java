 ...
 */
public class DiscoverEventViewGroup extends RelativeLayout {
    ...
    public DiscoverEventViewGroup(Context context) {
        super(context);
        init();
    }

    public DiscoverEventViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DiscoverEventViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        inflater.inflate(R.layout.view_group_discovery_event, this, true);
