...
public class DetailFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance) {
        View view = inflater.inflate(R.layout.fragment_serial_detail, container, false);
    ...
    void bind(SerialEpisode serialEpisode) {
        id = serialEpisode.getId();
        titleTextView.setText(serialEpisode.getTitle());
        if (!StringUtils.isEmpty(serialEpisode.getDescription())) {
            descriptionTextView.setText(serialEpisode.getDescription());
        } else {
            descriptionTextView.setText(R.string.no_info);
        }
        videoDetailViewGroup.bind(serialEpisode);
    }

    void setupVideo(SerialEpisode serialEpisode) {
        playerViewGroup.bind(serialEpisode);
        videoDetailViewGroup.bind(serialEpisode);
        playerViewGroup.bind(serialEpisode.getVideos());
    }

    void setupEpisodeList(SerialEpisodeListAdapter tvShowEpisodeListAdapter) {
        episodeListView.setAdapter(tvShowEpisodeListAdapter);
    }

    void updateEpisodeList(SerialEpisodeListAdapter tvShowEpisodeListAdapter) {
    ...
    void updateLike(SerialEpisode serialEpisode) {
        videoDetailViewGroup.bind(serialEpisode);
    }
}
