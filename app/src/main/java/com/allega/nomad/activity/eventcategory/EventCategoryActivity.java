 ...
 */
public class EventCategoryActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        controller = new EventCategoryController(this);
    }
    ...
    void setupViewPager(EventCategoryFragmentStateAdapter adapter) {
