...
public class DetailFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance) {
        View view = inflater.inflate(R.layout.fragment_live_channel_detail, container, false);
    ...
    void bind(LiveChannel liveChannel) {
        titleTextView.setText(liveChannel.getTitle());
        if (!StringUtils.isEmpty(liveChannel.getDescription())) {
            descriptionTextView.setText(liveChannel.getDescription());
        } else {
            descriptionTextView.setText(R.string.no_info);
        }
        videoDetailViewGroup.bind(liveChannel);
    }

    void setupVideo(LiveChannel liveChannel) {
        playerViewGroup.bind(liveChannel);
        videoDetailViewGroup.bind(liveChannel);
        playerViewGroup.bind(liveChannel.getVideos());
    }
    ...
    void updateLike(LiveChannel liveChannel) {
        videoDetailViewGroup.bind(liveChannel);
    }
}
