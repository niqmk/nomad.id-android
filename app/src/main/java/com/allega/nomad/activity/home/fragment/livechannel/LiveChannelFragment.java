 ...
 */
public class LiveChannelFragment extends BaseFragment implements ViewPager.OnPageChangeListener {
    ...
    long id;
    private LiveChannelController controller;

    public static LiveChannelFragment newInstance(LiveChannel liveChannel) {
        LiveChannelFragment liveChannelFragment = new LiveChannelFragment();
        Bundle bundle = new Bundle();
        bundle.putLong(EXTRA_ID, liveChannel.getId());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle sacvedInstanceState) {
        View view = inflater.inflate(R.layout.activity_live_channel, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        controller = new LiveChannelController(this, view);
    }

    @Override
    public void onResume() {
        super.onResume();
        sendGAScreenTracker(GAConstant.DETAIL_LIVE_CHANNEL_SCREEN);
    }
    ...
    void setupViewPager(LiveChannelFragmentStateAdapter movieFragmentStateAdapter) {
