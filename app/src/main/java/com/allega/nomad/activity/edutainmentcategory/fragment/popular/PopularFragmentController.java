 ...
 */
public class PopularFragmentController extends BaseFragmentController<PopularFragment> {
    ...
    public PopularFragmentController(PopularFragment fragment, View view) {
        super(fragment, view);
        ...
        getEdutainmentPopular();
    }

    private void getEdutainmentPopular() {
        appRestService.getEdutainmentPopular(null, new ResponseCallback<Response<Edutainment>>(context) {
            @Override
