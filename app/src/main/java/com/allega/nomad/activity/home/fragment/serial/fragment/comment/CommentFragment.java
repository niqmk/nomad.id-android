...
public class CommentFragment extends BaseFragment {
    ...
    private static final String ARG_EPISODE_ID = "arg-episode-id";
    ...
    public static CommentFragment newInstance(long episodeId) {
        CommentFragment commentFragment = new CommentFragment();
        Bundle bundle = new Bundle();
        bundle.putLong(ARG_EPISODE_ID, episodeId);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        episodeId = getArguments().getLong(ARG_EPISODE_ID);
    }
    ...
    public void setupCommentList(CommentSerialAdapter adapter) {
    ...
    public void updateList(CommentSerialAdapter adapter) {
