...
public class DetailFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance) {
        View view = inflater.inflate(R.layout.fragment_edutainment_detail, container, false);
    ...
    void bind(Edutainment edutainment) {
        titleTextView.setText(edutainment.getTitle());
        if (!StringUtils.isEmpty(edutainment.getDescription())) {
            descriptionTextView.setText(edutainment.getDescription());
        } else {
            descriptionTextView.setText(R.string.no_info);
        }
        videoDetailViewGroup.bind(edutainment);
    }

    void setupVideo(Edutainment edutainment) {
        playerViewGroup.bind(edutainment);
        playerViewGroup.bind(edutainment.getVideos());
        videoDetailViewGroup.bind(edutainment);
    }
    ...
    void updateLike(Edutainment edutainment) {
        videoDetailViewGroup.bind(edutainment);
    }
}
