 ...
 */
public class SerialEpisode extends RealmObject {
    ...
    @Expose
    private RealmList<SerialSeason> episodes = new RealmList<>();
    ...
    public RealmList<SerialSeason> getEpisodes() {
        return episodes;
    }

    public void setEpisodes(RealmList<SerialSeason> episodes) {
